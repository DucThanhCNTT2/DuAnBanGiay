...
<head>
    ...
    <style>
        ...
        body {
            background-color: #fdfdfd; /* Light background color for the body */
        }

        /* Set a custom background color for the header */
        header {
            background-color: #67727d; /* Dark background for the header */
        }

        /* Add a hover effect for navigation links */
        .navbar-nav .nav-item .nav-link:hover {
            background-color: #4a627a; /* Change background on hover */
            border-radius: 5px;
        }
        ...
        .d-flex a:hover {
            color: #e84d32; /* Color change on hover */
        }
        ...
        .search-form .btn {
            ...
            padding: 12px 20px;
            background-color: #c94754; /* Bootstrap danger color */
            border: none;
            font-size: 16px;
        }

        .search-form .btn:hover {
            background-color: #f3293d; /* Darker red on hover */
        }
...
<header class="bg-dark text-white p-3">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <!-- Menu Navigation -->
        <!-- Search form -->
        <form action="{{ route('ndtlogin.searchAdmins') }}" method="GET" class="search-form">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="{{route('admins.ndtLogin')}}" class="text-white text-decoration-none" style="font-size: 14px;">Đăng xuất</a>
        </div>
    </div>
</header>
